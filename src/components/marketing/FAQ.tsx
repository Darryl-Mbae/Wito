...
const FAQS = [
  ...
  {
    q: "Is Wito free?",
    a: "Yes — the Free plan includes unlimited events, registration pages, tasks, directors, attendance tracking, and calendar sync. Premium features like the Analytics, Attendance checkin tools etc require a Premium plan.",
  },
  {
    q: "How do I check in attendees at an event?",
    a: "From your event details page, click 'Generate Attendance QR Code' to create a unique QR code. Let users scan and mark as attended or open event details and mark them as attended in one tap.",
  },
